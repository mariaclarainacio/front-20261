    ...
    <div style={{ maxWidth: '600px', marginTop: '10px' }}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <textarea
            id="descricao" /* Adicionado o id combinando com o label */
            {...register("descricao", { 
              required: "Descrição é obrigatória", /* Ajustado o gênero apenas por garantia */
